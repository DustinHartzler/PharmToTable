<?php
/**
 * Template Name: Page for 14 Day Reset
 *
 * @package WordPress
		...
		<div class="container-full">
			<div class="row">
				...
				<div class="col-md-6 info">
					...
					<ul>
						<li><div class="info"><p>Bloating</p></div></li>
						<li><div class="info"><p>Inflammation</p></div></li>
						<li><div class="info"><p>Indigestion</p></div></li>
						<li><div class="info"><p>Low energy or fatigue</p></div></li>
						<li><div class="info"><p>Brain fog</p></div></li>
						<li><div class="info"><p>Chronic pain</p></div></li>
						<li><div class="info"><p>Headaches</p></div></li>
						<li><div class="info"><p>Fluid retention</p></div></li>
						<li><div class="info"><p>Food cravings</p></div></li>
						<li><div class="info"><p>Acne</p></div></li>
						<li><div class="info"><p>Mood swings</p></div></li>
						<li><div class="info"><p>Food sensitivities</p></div></li>
						<li><div class="info"><p>Allergies</p></div></li>
						<li><div class="info"><p>Difficulty losing weight</p></div></li>
						<li><div class="info"><p>Sensitivity to smells</p></div></li>
						<li><div class="info"><p>Sleep disturbances or insomnia</p></div></li>
					</ul>
					<br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 info">
                    ...
                    <div class="col-md-6 info">
                        <ul>
                            <li><div class="info"><p>environmental pollutants</p></div></li>
                            <li><div class="info"><p>hormone disruptors</p></div></li>
                        </ul>
                        </div>
                        <div class="col-md-6 info">
                        <ul>
                            <li><div class="info"><p>unhealthy estrogen metabolites</p></div></li>
                            <li><div class="info"><p>and so many more other harmful toxins</p></div></li>
                        </ul>
                    </div>
                    <div class="heading">
                                ...
                                <div class="col-md-8 opening-hours">
                                    <div class="opening-info" style="margin:30px;">
                                        ...
                                        <ul class="schedule" style="list-style-type: none">
                                            ...
                                            <li>Tue, March 22<br>8pm EST <div class="pull-right"> Detox Your Mind - The Role Stress Plays in Physical Health</div></li>
					...
					<div class="item">
						...
						<div class="info">
							...
							<div class="appoinment-btn">
								<a href="<?php echo get_post_meta( $post->ID, 'provider_azova', true ); ?>" target="_blank">View Bio</a>
							</div>
						</div>
					</div>
				</div>
