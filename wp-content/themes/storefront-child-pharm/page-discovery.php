<?php
/*
*Template Name: Page for FxMed Discovery Class
*/
 ?>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <h2 class="header">Functional Medicine <span>Discovery</span> Class</h2>
                    </a>
                </div>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated fadeInUp">Functional Medicine <span style="font-family: 'silver_south_scriptregular'; color: #71CABC">Discovery</span> Class</h1>
                                            <h2 data-animation="animated fadeInDown" style="color:black;">Learn how our Functional Medicine program can help you achieve your health goals.</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-6 info">
                    <div class="heading">
                        ...
                        <h4>By the time you finish this course, you’ll have the answers to the following questions:</h4>
                    </div>
                    <ul>
                        <li>
                            <div class="info">
                                <p>What is Functional Medicine?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
                                <p>How is it different from a traditional approach?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
                                <p>Why are pharmacists a key partner in your healthcare and suited for functional approach to care?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
                                <p>How can we overcome the challenges with our current healthcare system?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
                                <p>What will your first visit look like?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
                                <p>What can you expect in the coming months of our partnership?</p>
                            </div>
                        </li>
                        <li>
                            <div class="info">
