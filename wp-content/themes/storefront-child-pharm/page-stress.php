									...
									<div class="col-md-8">
										<div class="content">
											<h1 data-animation="animated fadeInUp">The <span
													style="font-family: 'silver_south_scriptregular'; color: #71CABC">Stress</span>
												Solution</h1>
											<h2 data-animation="animated fadeInDown" style="color:black;">A Course to
												Help You Reduce Stress and Heal Hormones</h2>
											<a data-animation="animated slideInUp" class="btn btn-theme effect btn-md"
												href="#checkout">Sign Up Now</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-md-6 info">
					...
					<ul>
						...
						<li>
							<div class="info">
								<p>Create a system to make small changes daily</p>
								</p>
							</div>
						</li>
					</ul>
									...
									<div class="col-md-8 opening-hours">
										<div class="opening-info">
											...
											<ul class="schedule" style="list-style-type: none">
												<li>Session 1<div class="pull-right"> Introduction to Functional
														Medicine</div>
												</li>
												<li>Session 2<div class="pull-right"> How Stress Hormones Work </div>
												</li>
												<li>Session 3<div class="pull-right"> Relaxation and Movement Break
													</div>
												</li>
												<li>Session 4<div class="pull-right"> How the Thyroid Works </div>
												</li>
												<li>Session 5<div class="pull-right"> How Female Hormones Impact Disease
													</div>
												</li>
												<li>Session 6<div class="pull-right"> Panel Discussion </div>
												</li>
												<li>Session 7<div class="pull-right"> Keeping a Healthy Gut </div>
												</li>
												<li>Session 8<div class="pull-right"> What to Eat </div>
												</li>
												<li>Session 9<div class="pull-right"> How to Breathe and Move </div>
												</li>
												<li>Session 10<div class="pull-right"> Personal Healing Stories </div>
												</li>
												<li>Session 11<div class="pull-right"> How to set SMART Goals </div>
												</li>
												<li>Session 12<div class="pull-right"> Breaking the Cycle of Disease
													</div>
												</li>
												<li>Session 13<div class="pull-right"> Final Q&A </div>
												</li>
											</ul>
										</div>
									</div>
				...
				<div class="row">
					<div class="doctor-items text-center">
						...
						<div class="col-md-4 col-sm-6 equal-height">
							<div class="item">
								<div class="thumb">
									<img src="https://functionalmedicinece.com/wp-content/uploads/2020/01/LindseyElmore.jpg"
										alt="Thumb">
									<div class="social">
										<ul>
											<li class="facebook">
						...
						<div class="col-md-4 col-sm-6 equal-height">
							<div class="item">
								<div class="thumb">
									<img src="https://functionalmedicinece.com/wp-content/uploads/2019/09/melody_hartzler-scaled.jpg"
										alt="Thumb">
									<div class="social">
										<ul>
											<li class="facebook">
												<a href="https://www.facebook.com/PharmtoTable.Life/" target="_blank"><i
														class="fab fa-facebook-f"></i></a>
											</li>
											<li class="instagram">
												<a href="https://www.instagram.com/pharmtotable.life/"
													target="_blank"><i class="fab fa-instagram"></i></a>
											</li>
											<li class="twitter">
												<a href="https://twitter.com/DrHartzler" target="_blank"><i
														class="fab fa-twitter"></i></a>
											</li>
											<li class="linkedin">
												<a href="https://www.linkedin.com/in/melody-hartzler-12667569/"
