...
<div class="popup-container reveal-modal" id="myModal">
	<div class="popup" id="register_popup">
		<!-- book image-->
		<img class="book-pop" src="https://pharmtotable.life/wp-content/uploads/2017/08/freeebook-small.png" id="book-popup"/>
		<div class="pop-right">
			<!-- pop header -->
			<div id="pop-head">
...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_52e28e4b77d42ca4c190e39ef_b0b7b955f6" tabindex="-1" value=""></div>
