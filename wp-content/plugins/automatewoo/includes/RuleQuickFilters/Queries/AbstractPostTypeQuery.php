...
/**
 * Class AbstractPostTypeQuery.
 *
 * @since   5.0.0
 * @package AutomateWoo\RuleQuickFilters\Queries
 */
abstract class AbstractPostTypeQuery extends AbstractQuery {
	 ...
	 */
	protected function get_results_count_by_clauses( $clauses ) {
	 ...
	 */
	protected function get_results_by_clauses( $clauses, $number, $offset = 0 ) {
