...
class TIE_Editor {
	...
	public function add_scripts() {
		...
		$data = array(
			...
			't'              => array(
				'copy'                        => __( 'Copy', 'thrive-image-editor' ),
				'saving'                      => __( 'Saving...', 'thrive-image-editor' ),
				'changes_auto_saved'          => __( 'Your changes are auto-saved', 'thrive-image-editor' ),
				'replace_image'               => __( 'Replace Image', 'thrive-image-editor' ),
				'select_bg_image'             => __( 'Select Background Image', 'thrive-image-editor' ),
				'media'                       => array(
					'title' => __( 'Choose background image', 'thrive-image-editor' ),
				),
				'image_required_for_position' => __( 'Please choose an image.', 'thrive-image-editor' ),
				'no_image_to_remove'          => __( 'No image to remove, you have to to choose one before.', 'thrive-image-editor' ),
				'enter_your_text_here'        => __( 'Enter your text here...', 'thrive-image-editor' ),
				'changes_saved'               => __( 'Changes saved', 'thrive-image-editor' ),
				'invalid_width'               => __( 'Invalid width, accepted value is between 100 and 1200', 'thrive-image-editor' ),
				'invalid_height'              => __( 'Invalid height, accepted value is between 100 and 1200', 'thrive-image-editor' ),
				'select_template'             => __( 'Please select a template', 'thrive-image-editor' ),
				'spectrum'                    => array(
					'choose' => __( 'choose', 'thrive-image-editor' ),
				),
			),
		);
		wp_localize_script( 'tie-editor-script', 'TIE_Editor', $data );

		tie_enqueue_script( 'tie-api-wistia-popover', '//fast.wistia.com/assets/external/popover-v1.js', array(), '', true );
	}
