...
this.contentElement&&this.contentElement.style&&this.hideContent(e)}},{key:"componentDidUpdate",value:function(e,t){var n,r,s=this,o=this.props,i=o.delay,a=o.duration,c=o.height,d=o.onAnimationEnd,m=o.onAnimationStart;
...
/* harmony export */});
/* harmony import */var r=n(92819),s=n(9818),o=n(29512),i=n.n(o),a=function(e,t){if(t){var n=t.match(/is-style-\w+/);if(n)return n[0]}var s=(0,r.find)(e,"isDefault");return s?"is-style-"+s.name:null},l=function(e,t){var n=(0,s.select)("core/block-editor").getBlock(e),r=n.attributes.className,o=n.name,l=(0,s.select)("core/blocks").getBlockStyles(o);if(function(e,t){return e&&e.some((function(e){return"is-style-"+e.name===t}))}(l,t)){var c=new(i())(r),u=a(l,r);u&&c.remove(u),c.add(t),(0,s.dispatch)("core/block-editor").updateBlockAttributes(e,{className:c.value})}};
/* harmony import */}
/***/,
/***/1849:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>d
/* harmony export */});
/* harmony import */var r=n(50189),s=n(69307),o=n(52175),i=n(65736),a=n(90180),l=n(16811),c=n(5077),u=n(86057),__=i.__;
/* harmony import */
...
/* harmony export */});
/* harmony import */var r=n(69307),s=n(60042),o=n.n(s),i=n(9818),a=n(52175),l=n(55609),c=n(65736),u=n(72469),d=n(63500),m=n(62993),__=c.__,p=function(e){var t=e.clientId,n=(0,i.useDispatch)(m/* .COURSE_STATUS_STORE */.o).setModuleStatus,s=(0,i.useSelect)((function(e){return e(m/* .COURSE_STATUS_STORE */.o).getModuleLessonCounts(t)}),[t]),c=u/* .Status.IN_PROGRESS */.q.IN_PROGRESS;0===s.completedLessonsCount?c=u/* .Status.NOT_STARTED */.q.NOT_STARTED:s.totalLessonsCount===s.completedLessonsCount&&s.totalLessonsCount>0&&(c=u/* .Status.COMPLETED */.q.COMPLETED);var p=s.totalLessonsCount>1?[u/* .Status.NOT_STARTED */.q.NOT_STARTED,u/* .Status.IN_PROGRESS */.q.IN_PROGRESS,u/* .Status.COMPLETED */.q.COMPLETED]:[u/* .Status.NOT_STARTED */.q.NOT_STARTED,u/* .Status.COMPLETED */.q.COMPLETED],f=u/* .Status.NOT_STARTED */.q.NOT_STARTED!==c,h=(0,r.createElement)("div",{className:o()("wp-block-sensei-lms-course-outline-module__progress-indicator",c)},(0,r.createElement)("span",{className:"wp-block-sensei-lms-course-outline-module__progress-indicator__text"},d/* .StatusLabels */.C[c]));return(0,r.createElement)(r.Fragment,null,f&&h,(0,r.createElement)(a.InspectorControls,null,(0,r.createElement)(l.PanelBody,{title:__("Status","sensei-lms"),initialOpen:!1},(0,r.createElement)(d/* .StatusControl */.I,{options:p,status:c,disabled:0===s.totalLessonsCount,setStatus:function(e){n(t,e)}}))))};
/* harmony import */}
/***/,
/***/5077:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>u
/* harmony export */});
/* harmony import */var r=n(69307),s=n(4981),o=n(9818),i=n(65736),a=n(73362),l=n(90180),c=n(92239),__=i.__;
/* harmony import */
/* harmony default export */const u=function(e){var t=e.clientId,n=(0,o.useDispatch)("core/block-editor").insertBlock,i=(0,o.useSelect)((function(e){return e("core/block-editor").getBlockCount(t)}),[]),u=[{title:__("Lesson","sensei-lms"),icon:a/* ["default"] */.Z,onClick:function(){return n((0,s.createBlock)("sensei-lms/course-outline-lesson",{placeholder:__("Lesson name","sensei-lms")}),i,t,!0)}},{title:__("Module","sensei-lms"),icon:l/* ["default"] */.Z,onClick:function(){return n((0,s.createBlock)("sensei-lms/course-outline-module"),i,t,!0)}}],d=__("Add Module or Lesson","sensei-lms");return(0,r.createElement)(c/* ["default"] */.Z,{controls:u,text:d,label:d})};
/***/},
/***/51836:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(9818),s=n(69307),o=n(67260),i=n(69973),a=function(e){var t=e.clientId,n=e.className,a=e.isPreview,l=e.attributes.moduleBorder,c=e.setAttributes,u=(0,s.useRef)(null),d=(0,r.useSelect)((function(e){return e("core/blocks").getBlockStyles("sensei-lms/course-outline")}),[]),m=(0,r.useDispatch)("core/block-editor").updateBlockAttributes,p=(0,o/* .getActiveStyleClass */.h)(d,n);(0,s.useEffect)((function(){if(!a&&p&&u.current!==p){if(!u.current)return void(u.current=p);u.current=p,(0,i/* .getCourseInnerBlocks */.tf)(t,"sensei-lms/course-outline-module").forEach((function(e){return(0,o/* .applyStyleClass */.z)(e.clientId,p)}))}}),[t,a,p,u]);return{moduleBorder:l,setModuleBorder:function(e){(0,i/* .getCourseInnerBlocks */.tf)(t,"sensei-lms/course-outline-module").forEach((function(t){m(t.clientId,{borderedSelected:e})})),c({moduleBorder:e})}}};
/* harmony import */}
/***/,
/***/72469:
/***/(e,t,n)=>{"use strict";
...
/* harmony import */var r=n(90228),s=n(64649),o=n(50189),i=n(92819),a=n(9818),l=n(23418),c=n(65736),u=n(20832),d=n(67959),__=(n(16400),c.__),m={IN_PROGRESS:"in-progress",IN_QUEUE:"in-queue"},p={
/**
...
/**
   ...
   */
runProcess:regeneratorRuntime.mark((function e(t){var n,r,s,o,u,d,f;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.slugs,r=t.actionType,e.next=3,(0,a.select)(g).getExtensionsByStatus(m.IN_PROGRESS);case 3:if(!(e.sent.length>0)){e.next=8;break}return e.next=7,p.addToQueue(t);case 7:return e.abrupt("return");case 8:return e.next=10,p.setExtensionsStatus(n,m.IN_PROGRESS);case 10:return"update"===r?(s={plugins:n},o=__("Update completed successfully!","sensei-lms"),// translators: Placeholder is the underlying error message.
...
u=__("There was an error while installing the plugin: %1$s","sensei-lms")),e.prev=11,e.next=14,(0,l.apiFetch)({path:"/sensei-internal/v1/sensei-extensions/".concat(r),method:"POST",data:s});case 14:return d=e.sent,e.next=17,p.setError(null);case 17:return e.next=19,p.setEntities({extensions:(0,i.keyBy)(d.completed,"product_slug")});case 19:return e.next=21,(0,a.dispatch)("core/notices").createNotice("success",o,{type:"snackbar"});case 21:e.next=27;break;case 23:return e.prev=23,e.t0=e.catch(11),e.next=27,p.setError((0,c.sprintf)(u,e.t0.message));case 27:return e.prev=27,e.next=30,p.setExtensionsStatus(n,"");case 30:return e.next=32,p.removeFromQueue(t);case 32:return e.next=34,(0,a.select)(g).getNextProcess();case 34:if(!(f=e.sent)){e.next=38;break}return e.next=38,p.runProcess(f);case 38:return e.finish(27);case 39:case"end":return e.stop()}}),e,null,[[11,23,27,39]])})),
/**
...
/**
   ...
   */
entities:{extensions:{}},connected:!1,layout:[],queue:[],error:null}),actions:p,selectors:f,resolvers:h,controls:l.controls});
/* harmony import */(0,a.register)(g)}
/***/,
/***/39359:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(4981),s=n(9818),o=n(39630),i=function(e){var t=e.insertBlocksAfter,n=e.name,i=e.clientId,a=e.attributes.title,l=(0,s.useDispatch)("core/block-editor"),c=l.selectNextBlock,u=l.removeBlock;return{onKeyDown:function(e){switch(e.keyCode){case o.ENTER:l=(0,s.select)("core/block-editor"),!(d=l.getBlock(l.getNextBlockClientId()))||d.attributes.title?t([(0,r.createBlock)(n)]):c(i);break;case o.BACKSPACE:!function(e){0===a.length&&(e.preventDefault(),u(i))}(e)}var l,d}}};
/* harmony import */}
/***/,
/***/69490:
/***/(e,t,n)=>{"use strict";
