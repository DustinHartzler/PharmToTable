...
return o.createElement("svg",i({viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg"},e),r||(r=o.createElement("path",{d:"M20 16V4H4v12h16z"})),s||(s=o.createElement("path",{d:"M18.5 5.5v9h-13v-9h13zM20 16H4V4h16v12zM6 20h2.222L11 16H8.778L6 20zm12 0h-2.222L13 16h2.222L18 20z"})))};
/***/},
/***/73362:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
// Percentage height
return"string"==typeof e&&e.search("%")===e.length-1&&h(e.substr(0,e.length-1))}function g(e,t){e&&"function"==typeof e&&e(t)}var b=function(e){function t(e){!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,t);var n=function(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));n.animationFrameIDs=[];var r="auto",o="visible";h(e.height)?(
...
this.contentElement.style.overflow="hidden";var b=this.contentElement.offsetHeight;this.contentElement.style.overflow="";
// set total animation time
var E=l+i,y=null,S={height:null,// it will be always set to either 'auto' or specific number
...
y=b,// TODO solve contentHeight = 0
...
this.animationClassesTimeoutID=setTimeout((function(){s.setState({animationStateClasses:C,shouldUseTransitions:!1}),
// ANIMATION ENDS
// Hide content if height is 0 (to prevent tabbing into it)
s.hideContent(S.height),
// Run a callback if it exists
g(d,{newHeight:S.height})}),E)):(
// ANIMATION STARTS, run a callback if it exists
g(m,{newHeight:y}),
// Set end height, classes and remove transitions when animation is complete
this.timeoutID=setTimeout((function(){S.animationStateClasses=C,S.shouldUseTransitions=!1,s.setState(S),
// ANIMATION ENDS
...
/* harmony import */
/* harmony default export */const g=(0,d/* .withColorSettings */.ku)({backgroundColor:{style:"background-color",label:__("Background color","sensei-lms")},textColor:{style:"color",label:__("Text color","sensei-lms")}})((function(e){var t=e.className,n=e.attributes,o=n.title,u=n.id,d=n.fontSize,g=n.draft,b=n.preview,E=n.placeholder,y=e.backgroundColor,S=e.textColor,w=e.setAttributes,k=(0,m/* .useKeydownInserter */.V)(e).onKeyDown,C=(0,v/* .useLessonPreviewStatus */.z)(e),_="";
/**
   * Update lesson title.
   *
   * @param {string} value Lesson title.
   */!u&&o.length?_=__("Unsaved","sensei-lms"):u&&g&&(_=__("Draft","sensei-lms"));var Z={className:i()(t,null==y?void 0:y.class,null==S?void 0:S.class,{completed:C.previewStatus===f/* .Status.COMPLETED */.q.COMPLETED,"is-auto-draft":!u&&!o}),style:{backgroundColor:null==y?void 0:y.color,color:null==S?void 0:S.color}};return(0,s.createElement)(s.Fragment,null,(0,s.createElement)(h/* ["default"] */.Z,(0,r/* ["default"] */.Z)({},e,C)),(0,s.createElement)("div",(0,r/* ["default"] */.Z)({},Z,{"data-lesson-id":u}),(0,s.createElement)(l/* ["default"] */.Z,{icon:a/* ["default"] */.Z,className:"wp-block-sensei-lms-course-outline-lesson__status"}),(0,s.createElement)(p/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline-lesson__input",placeholder:E||__("Add Lesson","sensei-lms"),value:o,onChange:function(e){w({title:e})},onKeyDown:k,style:{fontSize:d}}),b&&(0,s.createElement)("span",{className:"wp-block-sensei-lms-course-outline-lesson__badge"},__("Preview","sensei-lms")),_&&(0,s.createElement)("div",{className:"wp-block-sensei-lms-course-outline-lesson__post-status"},_),(0,s.createElement)(l/* ["default"] */.Z,{icon:c/* ["default"] */.Z,className:"wp-block-sensei-lms-course-outline-lesson__chevron"})))}));
/***/},
/***/95598:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */var r=n(66886),s=n(69307),o=n(60042),i=n.n(o),l=n(98286),a=n(52175),c=n(36414),u=n(12585),d=n(94333),m=n(9818),p=n(65736),f=n(22629),h=n(53112),v=n(75245),g=n(51836),b=n(3295),E=n(76774),y=n(36081),__=p.__,S=["sensei-lms/course-outline-lesson"];
/* harmony import */
/* harmony default export */const w=(0,d.compose)((0,h/* .withColorSettings */.ku)({mainColor:{style:"background-color",label:__("Main color","sensei-lms")},textColor:{style:"color",label:__("Text color","sensei-lms")},borderColor:{style:"border-color",label:__("Border color","sensei-lms"),onChange:function(e){var t=e.clientId,n=e.colorValue;return(0,m.dispatch)("core/block-editor").updateBlockAttributes(t,{borderColorValue:n})}}}),(0,h/* .withDefaultColor */.vD)({defaultMainColor:{style:"background-color",probeKey:"primaryColor"},defaultTextColor:{style:"color",probeKey:"primaryContrastColor"},defaultBorderColor:{style:"border-color",probeKey:"primaryColor"}}))((function(e){var t,n,o=e.clientId,d=e.className,m=e.attributes,p=m.title,h=m.description,w=m.borderedSelected,k=m.borderColorValue,C=m.teacher,_=m.slug,Z=e.mainColor,x=e.defaultMainColor,T=e.textColor,O=e.defaultTextColor,B=e.defaultBorderColor,L=e.setAttributes,N=(0,s.useContext)(g/* .OutlineAttributesContext */.G)||{outlineAttributes:{},outlineClassName:""},I=N.outlineAttributes,P=I.collapsibleModules,R=I.moduleBorder,A=N.outlineClassName;(0,v/* .useAutoInserter */.l)({name:"sensei-lms/course-outline-lesson",isEmptyBlock:function(e){return!e.title}},e);
/**
   * Handle update name.
   *
   * @param {string} value Name value.
   */
var D,M=(0,s.useState)(!0),j=(0,r/* ["default"] */.Z)(M,2),z=j[0],U=j[1],V=/is-style-(\w+)/,H=(null===(t=d.match(V))||void 0===t?void 0:t[1])||(null===(n=A.match(V))||void 0===n?void 0:n[1]),F={default:{background:(null==Z?void 0:Z.color)||(null==x?void 0:x.color),color:(null==T?void 0:T.color)||(null==O?void 0:O.color)},minimal:{color:null==T?void 0:T.color}}[H];
/**
   * Handle update name.
   *
   * @param {string} value Name value.
   */"minimal"===H&&(D=(0,s.createElement)("div",{className:"wp-block-sensei-lms-course-outline-module__name__minimal-border",style:{background:(null==Z?void 0:Z.color)||(null==x?void 0:x.color)}})),(0,s.useEffect)((function(){var e=document.querySelector('select[name="sensei-course-teacher-author"]');e&&e.addEventListener("change",(function(e){L({teacherId:e.target.value})}))}),// eslint-disable-next-line react-hooks/exhaustive-deps
[]);var q=void 0!==w?w:R;return(0,s.createElement)(s.Fragment,null,(0,s.createElement)(y/* ["default"] */.Z,{bordered:q,setBordered:function(e){return L({borderedSelected:e})},customSlug:_,setCustomSlug:function(e){L({slug:e})}}),(0,s.createElement)("section",{className:i()(d,{"wp-block-sensei-lms-course-outline-module-bordered":q}),style:{borderColor:k||(null==B?void 0:B.color)}},(0,s.createElement)("header",{className:"wp-block-sensei-lms-course-outline-module__header",style:F},(0,s.createElement)("h2",{className:"wp-block-sensei-lms-course-outline-module__title"},(0,s.createElement)(b/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline-module__title-input",placeholder:__("Module name","sensei-lms"),value:(0,f.decodeEntities)(p),onChange:function(e){L({title:e})}}),_&&(0,s.createElement)(s.Fragment,null,(0,s.createElement)("br",null),(0,s.createElement)("span",{className:"custom-slug"},"(",_,")"))),C&&(0,s.createElement)("span",{className:"teacher-name"},"(",C,")"),(0,s.createElement)(E/* .ModuleStatus */.n,{clientId:o}),P&&(0,s.createElement)("button",{type:"button",className:i()("wp-block-sensei-lms-course-outline__arrow",{"sensei-collapsed":!z}),onClick:function(){return U(!z)}},(0,s.createElement)(c/* ["default"] */.Z,{icon:u/* ["default"] */.Z}),(0,s.createElement)("span",{className:"screen-reader-text"},__("Toggle module content","sensei-lms")))),D,(0,s.createElement)(l/* ["default"] */.Z,{className:"wp-block-sensei-lms-collapsible",duration:500,animateOpacity:!0,height:!P||z?"auto":0},(0,s.createElement)("div",{className:"wp-block-sensei-lms-course-outline-module__description"},(0,s.createElement)(a.RichText,{className:"wp-block-sensei-lms-course-outline-module__description-input",placeholder:__("Module description","sensei-lms"),value:h,onChange:function(e){L({description:e})}})),(0,s.createElement)("h3",{className:"wp-block-sensei-lms-course-outline-module__lessons-title"},__("Lessons","sensei-lms")),(0,s.createElement)(a.InnerBlocks,{allowedBlocks:S,templateInsertUpdatesSelection:!1,renderAppender:function(){return null}}))))}));
/***/},
/***/36081:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */var r=n(69307);
/* harmony import */
/* harmony default export */const s=function(){return(0,r.createElement)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"304",height:"103",fill:"none",viewBox:"0 0 304 103"},(0,r.createElement)("g",{clipPath:"url(#clip0_4352_33523)"},(0,r.createElement)("path",{fill:"#DCFBE8",d:"M20 30c0-5.523 4.477-10 10-10h186c5.523 0 10 4.477 10 10s-4.477 10-10 10H30c-5.523 0-10-4.477-10-10z",opacity:"0.8"}),(0,r.createElement)("rect",{width:"303",height:"59",x:"0.5",y:"0.5",stroke:"#6FCFB2",rx:"1.5"}),(0,r.createElement)("path",{fill:"#DCFBE8",d:"M20 102c0-5.523 4.477-10 10-10h106c5.523 0 10 4.477 10 10s-4.477 10-10 10H30c-5.523 0-10-4.477-10-10z",opacity:"0.8"}),(0,r.createElement)("rect",{width:"303",height:"59",x:"0.5",y:"72.5",stroke:"#6FCFB2",rx:"1.5"})),(0,r.createElement)("defs",null,(0,r.createElement)("clipPath",{id:"clip0_4352_33523"},(0,r.createElement)("path",{fill:"#fff",d:"M0 0H304V132H0z"}))))};
/***/},
/***/46173:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */,Z:()=>v
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(94333),i=n(9818),l=n(69384),a=n(53112),c=n(31884),u=n(1849),d=n(31529),m=n(91333),p=n(49650),f=["sensei-lms/course-outline-module","sensei-lms/course-outline-lesson"],h=(0,r.createContext)();
/* harmony import */
/* harmony default export */const v=(0,o.compose)((0,a/* .withDefaultBlockStyle */.WJ)())((function(e){var t=e.clientId,n=e.className,o=e.attributes,a=e.setAttributes,v=(0,i.useDispatch)(u/* .COURSE_STORE */.v).loadStructure;(0,r.useEffect)((function(){o.isPreview||v()}),[o.isPreview,v]);var g=(0,d/* .useBlocksCreator */.g)(t).setBlocks,b=(0,i.useSelect)((function(e){return{isEmpty:!e(s.store).getBlocks(t).length}}),[t]).isEmpty;(0,c/* .useCourseLessonsStatusSync */.X)(t,o.isPreview);var E=(0,r.useCallback)((function(){return(0,r.createElement)(m/* ["default"] */.Z,{clientId:t})}),[t]);return b?(0,r.createElement)(p/* ["default"] */.Z,{addBlock:function(e){return g([{type:e}],!0)}}):(0,r.createElement)(h.Provider,{value:{outlineAttributes:o,outlineSetAttributes:a,outlineClassName:n}},(0,r.createElement)(l/* ["default"] */.Z,e),(0,r.createElement)("section",{className:n},(0,r.createElement)(s.InnerBlocks,{allowedBlocks:f,renderAppender:E})))}));
/***/},
/***/49650:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>m
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(55609),i=n(65736),l=n(46173),a=n(69490),c=n(89694),u=n(20436),d=n(97921),__=i.__;
/* harmony import */
/* harmony default export */const m=function(e){var t=e.addBlock,n=window.sensei.aiCourseOutline?__("Build and display a course outline.","sensei-lms"):__("Build and display a course outline. A course is made up of modules (optional) and lessons. You can use modules to group related lessons together.","sensei-lms"),i=window.sensei.aiCourseOutline?(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder-items"},(0,r.createElement)("figure",{className:"wp-block-sensei-lms-course-outline__placeholder-item is-blank"},(0,r.createElement)("p",{className:"wp-block-sensei-lms-course-outline__placeholder-item-intro"},__("Start with a blank canvas and create your own course outline.","sensei-lms")),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder-item-details"},(0,r.createElement)("li",null,__("Add Lessons and Modules","sensei-lms")),(0,r.createElement)("li",null,__("Reorder and edit anytime","sensei-lms"))),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder-item-lessons"},(0,r.createElement)("li",null,__("Lesson 1","sensei-lms")),(0,r.createElement)("li",null,__("Lesson 2","sensei-lms"))),(0,r.createElement)("figcaption",{className:"wp-block-sensei-lms-course-outline__placeholder-item-caption"},__("Start with blank","sensei-lms"))),(0,r.createElement)("figure",{className:"wp-block-sensei-lms-course-outline__placeholder-item is-ai"},(0,r.createElement)("div",null,(0,r.createElement)("p",{className:"wp-block-sensei-lms-course-outline__placeholder-item-intro"},__("Get AI's help to start with a tailored course outline.","sensei-lms")),(0,r.createElement)(a/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline__placeholder-item-icon"})),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder-item-details"},(0,r.createElement)("li",null,(0,r.createElement)(u/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline__placeholder-item-icon"}),__("AI tailored outline based on your content","sensei-lms")),(0,r.createElement)("li",null,(0,r.createElement)(u/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline__placeholder-item-icon"}),__("Access to all Sensei Pro features","sensei-lms"))),(0,r.createElement)(c/* ["default"] */.Z,null),(0,r.createElement)("figcaption",{className:"wp-block-sensei-lms-course-outline__placeholder-item-caption"},__("Generate with AI","sensei-lms"),(0,r.createElement)(d/* ["default"] */.Z,null)))):(0,r.createElement)(r.Fragment,null,(0,r.createElement)(o.Button,{isDefault:!0,onClick:function(){return t("module")},className:"is-large"},__("Create a module","sensei-lms")),(0,r.createElement)(o.Button,{isDefault:!0,onClick:function(){return t("lesson")},className:"is-large"},__("Create a lesson","sensei-lms")));return(0,r.createElement)(o.Placeholder,{className:"wp-block-sensei-lms-course-outline__placeholder",label:__("Course Outline","sensei-lms"),icon:(0,r.createElement)(s.BlockIcon,{icon:l/* ["default"].icon */.Z.icon,showColors:!0}),instructions:n},i)};
/***/},
/***/30553:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(4981),s=n(9818),o=n(69307),i=n(92819),l=function(e,t){var n=e.name,l=e.attributes,a=void 0===l?{}:l,c=e.selectFirstBlock,u=void 0!==c&&c,d=e.isEmptyBlock,m=t.clientId,p=(0,s.useDispatch)("core/block-editor"),f=p.__unstableMarkNextChangeAsNotPersistent,h=void 0===f?i.noop:f,v=p.insertBlock,g=(0,s.useSelect)((function(e){return e("core/block-editor").getBlocks(m)})),b=0===g.length,E=(0,o.useCallback)((function(){var e=(0,r.createBlock)(n,a),t=b&&u;h(),v(e,void 0,m,t)}),[h,v,m,n,a,b,u]),y=g.length&&g[g.length-1],S=y&&d(y.attributes);(0,o.useEffect)((function(){S||E()}),[S,E])};
/* harmony import */}
/***/,
/***/26622:
/***/(e,t,n)=>{"use strict";
 ...
 */
function u(e){var t,n,u,d=e.storeName,m=e.getEndpoint,p=e.saveError,f=e.fetchError,h=e.clearError,v=e.updateBlock,g=e.blockExists,b=e.readBlock,E=e.setServerStructure,y=(0,s/* ["default"] */.Z)(e,c),S={
/**
