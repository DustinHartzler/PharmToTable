...
/* harmony import */var e=n(66886),t=n(69307),r=n(55609),s=n(82857),o=n(65736),i=n(9240),__=o.__,a=function(n){var o=n.studentId,a=n.studentName,u=n.studentDisplayName,l=(0,t.useState)(""),c=(0,e/* ["default"] */.Z)(l,2),d=c[0],m=c[1],f=(0,t.useState)(!1),p=(0,e/* ["default"] */.Z)(f,2),v=p[0],h=p[1],g=[{title:__("Add to Course","sensei-lms"),onClick:function(){return y()}},{title:__("Remove from Course","sensei-lms"),onClick:function(){return w()}},{title:__("Reset or Remove Progress","sensei-lms"),onClick:function(){return b()}},{title:__("Grading","sensei-lms"),onClick:function(){return window.open("admin.php?page=sensei_grading&view=ungraded&s=".concat(a),"_self")}}],y=function(){m("add"),h(!0)},w=function(){m("remove"),h(!0)},b=function(){m("reset-progress"),h(!0)};return(0,t.createElement)(t.Fragment,null,(0,t.createElement)(r.DropdownMenu,{icon:s/* ["default"] */.Z,label:__("Select an action","sensei-lms"),controls:g}),v&&(0,t.createElement)(i/* ["default"] */.Z,{action:d,onClose:function(e){e&&window.location.reload(),h(!1)},students:[o],studentDisplayName:u}))};
