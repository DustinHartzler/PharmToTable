...
/* harmony import */
/* harmony default export */const h=function(){var e=(0,a.useSelect)((function(e){return e("core/editor").getCurrentPost()})),t=(0,i.useState)(window.sensei.courseSettingsSidebar.author),n=(0,o/* ["default"] */.Z)(t,2),l=n[0],d=n[1],h=window.sensei.courseSettingsSidebar.courses;h&&h.length&&(h=h.map((function(e){return{label:e.post_title,value:e.ID}})),h.push({label:__("None","sensei-lms"),value:0}));var v=window.sensei.courseSettingsSidebar.teachers;v&&v.length&&(v=v.map((function(e){return{label:e.display_name,value:e.id}})));var b=(0,u.useEntityProp)("postType","course","meta"),w=(0,o/* ["default"] */.Z)(b,2),_=w[0],E=w[1],y=_._course_featured,S=_._course_prerequisite,Z=_.disable_notification;(0,i.useEffect)((function(){return(0,g/* ["default"] */.Z)({onSaveStart:function(){if(l!==e.author){var t,n=(0,f/* .getFirstBlockByName */.H4)("sensei-lms/course-outline",(0,a.select)("core/block-editor").getBlocks()),s=n&&(0,f/* .extractStructure */.Vw)(n.innerBlocks).filter((function(e){return e.slug})).map((function(e){return e.slug}));m()({path:"/sensei-internal/v1/course-utils/update-teacher",method:"PUT",data:(t={},(0,r/* ["default"] */.Z)(t,window.sensei.courseSettingsSidebar.nonce_name,window.sensei.courseSettingsSidebar.nonce_value),(0,r/* ["default"] */.Z)(t,"post_id",e.id),(0,r/* ["default"] */.Z)(t,"teacher",l),(0,r/* ["default"] */.Z)(t,"custom_slugs",JSON.stringify(s)),t)}).catch((function(e){e.message&&(0,a.dispatch)("core/notices").createNotice("warning",e.message,{isDismissible:!0})}))}}})}));
/**
   ...
   */
var P=(0,p.applyFilters)("senseiCourseSettingsMultipleTeachersUpgradeHide",!1),x=(0,i.useMemo)((function(){return(0,p.applyFilters)("senseiCourseSettingsTeachersAfter",(function(){return null}))}),[]);
/**
   ...
   */return(0,i.createElement)(c.PanelBody,{title:__("General","sensei-lms"),initialOpen:!0},(0,i.createElement)("h3",null,__("Teacher","sensei-lms")),v.length?(0,i.createElement)(c.SelectControl,{value:l,options:v,onChange:function(t){t=parseInt(t),d(t),(0,a.dispatch)("core").editEntityRecord("postType","course",e.id,{author:t})}}):null,!P&&(0,i.createElement)("div",{className:"sensei-course-coteachers-wrapper"},__("Multiple teachers?","sensei-lms")," ",(0,i.createElement)(c.ExternalLink,{href:"https://senseilms.com/sensei-pro/?utm_source=plugin_sensei&utm_medium=upsell&utm_campaign=co-teachers"},__("Upgrade to Sensei Pro","sensei-lms"))),(0,i.createElement)(x,{courseAuthorId:l,courseId:e.id}),(0,i.createElement)(c.HorizontalRule,null),(0,i.createElement)("h3",null,__("Course Prerequisite","sensei-lms")),h.length?null:(0,i.createElement)("p",null,__("No courses exist yet. Please add some first.","sensei-lms")),h.length?(0,i.createElement)(c.SelectControl,{value:S,options:h,onChange:function(e){return E((0,s/* ["default"] */.Z)((0,s/* ["default"] */.Z)({},_),{},{_course_prerequisite:e}))}}):null,(0,i.createElement)(c.HorizontalRule,null),(0,i.createElement)("h3",null,__("Featured Course","sensei-lms")),(0,i.createElement)(c.CheckboxControl,{label:__("Feature this course.","sensei-lms"),checked:"featured"==y,onChange:function(e){return E((0,s/* ["default"] */.Z)((0,s/* ["default"] */.Z)({},_),{},{_course_featured:e?"featured":""}))}}),(0,i.createElement)(c.HorizontalRule,null),(0,i.createElement)("h3",null,__("Course Notifications","sensei-lms")),(0,i.createElement)(c.CheckboxControl,{label:__("Disable notifications on this course?","sensei-lms"),checked:Z,onChange:function(e){return E((0,s/* ["default"] */.Z)((0,s/* ["default"] */.Z)({},_),{},{disable_notification:e}))}}),(0,i.createElement)(c.HorizontalRule,null),(0,i.createElement)("h3",null,__("Course Management","sensei-lms")),(0,i.createElement)("p",null,(0,i.createElement)("a",{href:"/wp-admin/admin.php?page=sensei_learners&course_id=".concat(e.id,"&view=learners")},__("Manage Students","sensei-lms"))),(0,i.createElement)("p",null,(0,i.createElement)("a",{href:"/wp-admin/admin.php?page=sensei_grading&course_id=".concat(e.id,"&view=learners")},__("Manage Grading","sensei-lms"))))};
/***/},
/***/17323:
/***/(e,t,n)=>{
/* harmony export */n.d(t,{
