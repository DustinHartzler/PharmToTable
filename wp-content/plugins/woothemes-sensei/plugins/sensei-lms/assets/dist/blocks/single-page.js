...
/* harmony export */Z:()=>p
/* harmony export */});
/* harmony import */var s=r(69307),o=r(60042),n=r.n(o),l=r(94333),a=r(54286),i=r(53112),c=r(9818),u=r(65736),__=u.__,d=function(e){var t=e.lessonNumber;return(0,s.createElement)("li",{className:"wp-block-sensei-lms-course-results__lesson"},(0,s.createElement)("a",{href:"#",className:"wp-block-sensei-lms-course-results__lesson-link"},(0,s.createElement)("span",{className:"wp-block-sensei-lms-course-results__lesson-title"},(0,u.sprintf)(/* translators: Mock lesson number. */
...
var e=document.createElement("div");e.className="editor-styles-wrapper sensei-probe-element";var t=document.createElement("div");t.className="wp-block-button";var r=document.createElement("div");r.className="wp-block-button__link",r.textContent="Probe",
// Set probe position outside the screen to be hidden.
e.style.position="fixed",e.style.top="-100vh",
// Add probe to the screen.
t.appendChild(r),e.appendChild(t),document.body.appendChild(e);
// Save styles.
var s={primaryColor:i(r).backgroundColor,primaryContrastColor:i(r).color};
// Remove probe.
