...
return s.createElement("svg",o({viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg"},e),r||(r=s.createElement("path",{d:"M9 18.6 3.5 13l1-1L9 16.4l9.5-9.9 1 1z",fill:"currentColor"})))};
/***/},
/***/29375:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */function o(){return o=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},o.apply(this,arguments)}
/* harmony default export */const i=function(e){
return s.createElement("svg",o({width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg"},e),r||(r=s.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M19 4.5H5a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h14a.5.5 0 0 0 .5-.5V5a.5.5 0 0 0-.5-.5ZM5 3a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h4.511l-1.03 2.75H7a.75.75 0 0 0 0 1.5h10a.75.75 0 0 0 0-1.5h-1.48L14.489 16H19a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5Zm5 3.5 5 3-5 3v-6Zm3.918 12.25h-3.836l.938-2.5h1.96l.938 2.5Z",fill:"#1E1E1E"})))};
/***/},
/***/73362:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */function o(){return o=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},o.apply(this,arguments)}
/* harmony default export */const i=function(e){
return s.createElement("svg",o({viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg"},e),r||(r=s.createElement("path",{d:"M4 4v12h4.777L6 20h2.223L11 16h2l2.777 4H18l-2.777-4H20V4zm1.5 1.5h13v9h-13zM9 8v1.5h6V8zm0 3v1.5h6V11z",clipRule:"evenodd",fillRule:"evenodd"})))};
/***/},
/***/33731:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */function i(){return i=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},i.apply(this,arguments)}
/* harmony default export */const l=function(e){
return o.createElement("svg",i({viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg"},e),r||(r=o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M18.5 5.5v9h-13v-9h13zM20 16H4V4h16v12z"})),s||(s=o.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M9 12h6V8H9v4zm-3 8h2.222L11 16H8.778L6 20zm12 0h-2.222L13 16h2.222L18 20z"})))};
/***/},
/***/36414:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
 ...
 * WordPress dependencies
 */
const o=(0,r.createElement)(s.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,r.createElement)(s.Path,{d:"M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z"}));
/* harmony default export */}
 ...
 */var r=n(90331);function s(){}function o(){}o.resetWarningCache=s,e.exports=function(){function e(e,t,n,s,o,i){if(i!==r){var l=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw l.name="Invariant Violation",l}}function t(){return e}e.isRequired=e;
// Important!
// Keep this list in sync with production version in `./factoryWithTypeCheckers.js`.
var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:o,resetWarningCache:s};return n.PropTypes=n,n}}
/***/,
/***/23615:
/***/(e,t,n)=>{
...
// If value is string "0%" make sure we convert it to number 0
r="0%"===e.height?0:e.height,o="hidden"),n.animationStateClasses=s({},d,e.animationStateClasses);var i=n.getStaticStateClasses(r);return n.state={animationStateClasses:i,height:r,overflow:o,shouldUseTransitions:!1},n}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}(t,e),o(t,[{key:"componentDidMount",value:function(){var e=this.state.height;
// Hide content if height is 0 (to prevent tabbing into it)
// Check for contentElement is added cause this would fail in tests (react-test-renderer)
// Read more here: https://github.com/Stanko/react-animate-height/issues/17
this.contentElement&&this.contentElement.style&&this.hideContent(e)}},{key:"componentDidUpdate",value:function(e,t){var n,r,s=this,o=this.props,i=o.delay,l=o.duration,c=o.height,d=o.onAnimationEnd,m=o.onAnimationStart;
...
var b=l+i,y=null,S={height:null,// it will be always set to either 'auto' or specific number
...
// Add webkit vendor prefix still used by opera, blackberry...
C.WebkitTransition=C.transition,0===y&&(C.opacity=0));var x=(0,a.default)((u(e={},_,!0),u(e,c,c),e)),Z=void 0!==this.props["aria-hidden"]?this.props["aria-hidden"]:0===y;
// Check if user passed aria-hidden prop
return i.default.createElement("div",s({},p.apply(void 0,[this.props].concat(m)),{"aria-hidden":Z,className:x,id:g,style:k}),i.default.createElement("div",{className:d,style:C,ref:function(e){return t.contentElement=e}},l))}}]),t}(i.default.Component);E.propTypes={"aria-hidden":l.default.bool,animateOpacity:l.default.bool,animationStateClasses:l.default.object,applyInlineTransitions:l.default.bool,children:l.default.any.isRequired,className:l.default.string,contentClassName:l.default.string,delay:l.default.number,duration:l.default.number,easing:l.default.string,height:function(e,t,n){var s=e[t];return"number"==typeof s&&s>=0||v(s)||"auto"===s?null:new TypeError('value "'+s+'" of type "'+(void 0===s?"undefined":r(s))+'" is invalid type for '+t+" in "+n+'. It needs to be a positive number, string "auto" or percentage string (e.g. "15%").')},id:l.default.string,onAnimationEnd:l.default.func,onAnimationStart:l.default.func,style:l.default.object},E.defaultProps={animateOpacity:!1,animationStateClasses:d,applyInlineTransitions:!0,duration:250,delay:0,easing:"ease",style:{}},t.Z=E}
/***/,
/***/67260:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(9818),s=n(65736),o=n(23728),i=n(69973),__=s.__,l=function(){return(0,i/* .getFirstBlockByName */.H4)("sensei-lms/course-outline",(0,r.select)("core/block-editor").getBlocks())},a="sensei/course-structure";
...
/* harmony export */,iT:()=>/* reexport safe */s.Z
/* harmony export */,G$:()=>/* reexport safe */o.Z
/* harmony export */});
/* harmony import */var r=n(46173),s=n(90086),o=n(31458);
...
/* harmony export */Z:()=>a
/* harmony export */});
/* harmony import */var r=n(50189),s=n(65736),o=n(73362),i=n(28880),l=n(37231),__=s.__;
/* harmony import */
/* harmony default export */const a=(0,r/* ["default"] */.Z)((0,r/* ["default"] */.Z)({},l),{},{metadata:l,icon:o/* ["default"] */.Z,example:{attributes:{title:__("Start learning","sensei-lms")}},edit:i/* ["default"] */.Z});
/***/},
/***/63028:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */,C:()=>m
/* harmony export */});
/* harmony import */var r=n(69307),s=n(55609),o=n(9818),i=n(72067),l=n(12238),a=n(65736),c=n(1849),__=a.__,u=function(e){return"post.php?post=".concat(e,"&action=edit")},d=function(e){var t=e.lessonId;return(0,r.createElement)(s.ExternalLink,{href:u(t),target:"lesson",className:"wp-block-sensei-lms-course-outline-lesson__edit"},__("Edit lesson","sensei-lms"))};
/* harmony import */
/* harmony default export */const m=function(e){var t=e.lessonId,n=e.lessonTitle,a=(0,o.useSelect)((function(e){return{isSavingPost:e(l.store).isSavingPost(),isSavingMetaBoxes:e(i.store).isSavingMetaBoxes(),isSavingStructure:e(c/* .COURSE_STORE */.v).getIsSavingStructure()}})),u=a.isSavingPost,m=a.isSavingMetaBoxes,p=a.isSavingStructure,f=(0,o.useDispatch)(l.store).savePost;
...
/* harmony import */var r=n(25773),s=n(69307),o=n(60042),i=n.n(o),l=n(36414),a=n(80454),c=n(23455),u=n(65736),d=n(53112),m=n(26622),p=n(3295),f=n(72469),h=n(95598),v=n(76515),__=u.__;
/* harmony import */
...
/**
   ...
   */!u&&o.length?C=__("Unsaved","sensei-lms"):u&&g&&(C=__("Draft","sensei-lms"));var x={className:i()(t,null==y?void 0:y.class,null==S?void 0:S.class,{completed:k.previewStatus===f/* .Status.COMPLETED */.q.COMPLETED,"is-auto-draft":!u&&!o}),style:{backgroundColor:null==y?void 0:y.color,color:null==S?void 0:S.color}};return(0,s.createElement)(s.Fragment,null,(0,s.createElement)(h/* ["default"] */.Z,(0,r/* ["default"] */.Z)({},e,k)),(0,s.createElement)("div",(0,r/* ["default"] */.Z)({},x,{"data-lesson-id":u}),(0,s.createElement)(l/* ["default"] */.Z,{icon:a/* ["default"] */.Z,className:"wp-block-sensei-lms-course-outline-lesson__status"}),(0,s.createElement)(p/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline-lesson__input",placeholder:b||__("Add Lesson","sensei-lms"),value:o,onChange:function(e){_({title:e})},onKeyDown:w,style:{fontSize:d}}),E&&(0,s.createElement)("span",{className:"wp-block-sensei-lms-course-outline-lesson__badge"},__("Preview","sensei-lms")),C&&(0,s.createElement)("div",{className:"wp-block-sensei-lms-course-outline-lesson__post-status"},C),(0,s.createElement)(l/* ["default"] */.Z,{icon:c/* ["default"] */.Z,className:"wp-block-sensei-lms-course-outline-lesson__chevron"})))}));
/***/},
/***/95598:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>d
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(55609),i=n(9818),l=n(65736),a=n(72469),c=n(63500),u=n(63028),__=l.__;
/* harmony import */
/* harmony default export */const d=function(e){var t=e.previewStatus,n=e.setPreviewStatus,l=e.setAttributes,d=e.attributes,m=d.id,p=d.fontSize,f=d.title,h=(0,i.useSelect)((function(e){return e("core/block-editor").getSettings()})).fontSizes;return(0,r.createElement)(r.Fragment,null,(0,r.createElement)(s.InspectorControls,null,m&&(0,r.createElement)(o.PanelBody,{title:__("Lesson","sensei-lms")},(0,r.createElement)("h2",null,(0,r.createElement)(u/* .EditLessonLink */.Z,{lessonId:m})),(0,r.createElement)("p",null,__("Edit details such as lesson content, prerequisite, quiz settings and more.","sensei-lms"))),(0,r.createElement)(o.PanelBody,{title:__("Typography","sensei-lms")},(0,r.createElement)(o.FontSizePicker,{fontSizes:h,value:p,onChange:function(e){l({fontSize:e})}})),(0,r.createElement)(o.PanelBody,{title:__("Status","sensei-lms"),initialOpen:!1},(0,r.createElement)(c/* .StatusControl */.I,{status:t,setStatus:n,options:[a/* .Status.NOT_STARTED */.q.NOT_STARTED,a/* .Status.COMPLETED */.q.COMPLETED],disabled:!f}))),(0,r.createElement)(s.BlockControls,null,(0,r.createElement)(u/* ["default"] */.C,{lessonId:m,lessonTitle:f})))};
/***/},
/***/76515:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
return(0,s.useEffect)((function(){n||(i.length>0?u(l):d(l))}),[l,u,d,i,n]),{setPreviewStatus:function(e){return c(l,e)},previewStatus:(0,r.useSelect)((function(e){return e(o/* .COURSE_STATUS_STORE */.o).getLessonStatus(l)}),[l])}};
/* harmony import */}
/***/,
/***/90086:
/***/(e,t,n)=>{"use strict";
...
/* harmony import */var r=n(66886),s=n(69307),o=n(60042),i=n.n(o),l=n(98286),a=n(52175),c=n(36414),u=n(12585),d=n(94333),m=n(9818),p=n(65736),f=n(22629),h=n(53112),v=n(75245),g=n(51836),E=n(3295),b=n(76774),y=n(36081),__=p.__,S=["sensei-lms/course-outline-lesson"];
/* harmony import */
...
/* harmony export */Z:()=>l
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(55609),i=n(65736),__=i.__;
/* harmony import */
/* harmony default export */const l=function(e){var t=e.bordered,n=e.setBordered,i=e.customSlug,l=e.setCustomSlug;return(0,r.createElement)(s.InspectorControls,null,(0,r.createElement)(o.PanelBody,{title:__("Border settings","sensei-lms"),initialOpen:!1},(0,r.createElement)(o.ToggleControl,{checked:t,onChange:n,label:__("Border","sensei-lms"),help:__("Toggle to enable the border.","sensei-lms")})),(0,r.createElement)(o.PanelBody,{title:__("Custom slug","sensei-lms"),initialOpen:i||!1},(0,r.createElement)(o.TextControl,{className:"wp-block-sensei-lms-course-outline-module__slug-input",placeholder:__("Optional, keep empty for default","sensei-lms"),value:i,onChange:l})))};
/***/},
/***/76774:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(69307),s=n(60042),o=n.n(s),i=n(9818),l=n(52175),a=n(55609),c=n(65736),u=n(72469),d=n(63500),m=n(62993),__=c.__,p=function(e){var t=e.clientId,n=(0,i.useDispatch)(m/* .COURSE_STATUS_STORE */.o).setModuleStatus,s=(0,i.useSelect)((function(e){return e(m/* .COURSE_STATUS_STORE */.o).getModuleLessonCounts(t)}),[t]),c=u/* .Status.IN_PROGRESS */.q.IN_PROGRESS;0===s.completedLessonsCount?c=u/* .Status.NOT_STARTED */.q.NOT_STARTED:s.totalLessonsCount===s.completedLessonsCount&&s.totalLessonsCount>0&&(c=u/* .Status.COMPLETED */.q.COMPLETED);var p=s.totalLessonsCount>1?[u/* .Status.NOT_STARTED */.q.NOT_STARTED,u/* .Status.IN_PROGRESS */.q.IN_PROGRESS,u/* .Status.COMPLETED */.q.COMPLETED]:[u/* .Status.NOT_STARTED */.q.NOT_STARTED,u/* .Status.COMPLETED */.q.COMPLETED],f=u/* .Status.NOT_STARTED */.q.NOT_STARTED!==c,h=(0,r.createElement)("div",{className:o()("wp-block-sensei-lms-course-outline-module__progress-indicator",c)},(0,r.createElement)("span",{className:"wp-block-sensei-lms-course-outline-module__progress-indicator__text"},d/* .StatusLabels */.C[c]));return(0,r.createElement)(r.Fragment,null,f&&h,(0,r.createElement)(l.InspectorControls,null,(0,r.createElement)(a.PanelBody,{title:__("Status","sensei-lms"),initialOpen:!1},(0,r.createElement)(d/* .StatusControl */.I,{options:p,status:c,disabled:0===s.totalLessonsCount,setStatus:function(e){n(t,e)}}))))};
/* harmony import */}
/***/,
/***/5077:
/***/(e,t,n)=>{"use strict";
 ...
 */
/* harmony default export */const s={from:[{type:"block",blocks:["sensei-lms/course-outline-lesson"],isMultiBlock:!0,
/**
...
/* harmony import */var r=n(69307);
/* harmony import */
/* harmony default export */const s=function(){return(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__ai-image"},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__ai-image__item"},(0,r.createElement)("div",{style:{width:"78%"},className:"wp-block-sensei-lms-course-outline__ai-image__content"})),(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__ai-image__item"},(0,r.createElement)("div",{style:{width:"47%"},className:"wp-block-sensei-lms-course-outline__ai-image__content"})),(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__ai-image__item"},(0,r.createElement)("div",{style:{width:"25%"},className:"wp-block-sensei-lms-course-outline__ai-image__content"})))};
/***/},
/***/323:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(55609),i=n(65736),l=n(46173),__=i.__,a=function(e){var t=e.addBlock;return(0,r.createElement)(o.Placeholder,{className:"wp-block-sensei-lms-course-outline__placeholder",label:__("Course Outline","sensei-lms"),icon:(0,r.createElement)(s.BlockIcon,{icon:l/* ["default"].icon */.Z.icon,showColors:!0}),instructions:__("Build and display a course outline. A course is made up of modules (optional) and lessons. You can use modules to group related lessons together.","sensei-lms")},(0,r.createElement)(o.Button,{isDefault:!0,onClick:function(){return t("module")},className:"is-large"},__("Create a module","sensei-lms")),(0,r.createElement)(o.Button,{isDefault:!0,onClick:function(){return t("lesson")},className:"is-large"},__("Create a lesson","sensei-lms")))};
/* harmony import */}
/***/,
/***/46173:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>u
/* harmony export */});
/* harmony import */var r=n(69307),s=n(4981),o=n(9818),i=n(65736),l=n(73362),a=n(90180),c=n(92239),__=i.__;
/* harmony import */
/* harmony default export */const u=function(e){var t=e.clientId,n=(0,o.useDispatch)("core/block-editor").insertBlock,i=(0,o.useSelect)((function(e){return e("core/block-editor").getBlockCount(t)}),[]),u=[{title:__("Lesson","sensei-lms"),icon:l/* ["default"] */.Z,onClick:function(){return n((0,s.createBlock)("sensei-lms/course-outline-lesson",{placeholder:__("Lesson name","sensei-lms")}),i,t,!0)}},{title:__("Module","sensei-lms"),icon:a/* ["default"] */.Z,onClick:function(){return n((0,s.createBlock)("sensei-lms/course-outline-module"),i,t,!0)}}],d=__("Add Module or Lesson","sensei-lms");return(0,r.createElement)(c/* ["default"] */.Z,{controls:u,text:d,label:d})};
/***/},
/***/51836:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */,Z:()=>E
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(94333),i=n(9818),l=n(69384),a=n(53112),c=n(31884),u=n(1849),d=n(31529),m=n(91333),p=n(49650),f=n(9025),h=n(92694),v=["sensei-lms/course-outline-module","sensei-lms/course-outline-lesson"],g=(0,r.createContext)();
/* harmony import */
/* harmony default export */const E=(0,o.compose)((0,a/* .withDefaultBlockStyle */.WJ)())((function(e){var t=e.clientId,n=e.className,o=e.attributes,a=e.setAttributes,E=(0,i.useDispatch)(u/* .COURSE_STORE */.v).loadStructure,b=(0,f/* ["default"] */.Z)().isActivated,y=(0,h.applyFilters)("senseiCourseOutlineGeneratorUpsellRemove",b);(0,r.useEffect)((function(){o.isPreview||E()}),[o.isPreview,E]);var S=(0,d/* .useBlocksCreator */.g)(t).setBlocks,_=(0,i.useSelect)((function(e){return{isEmpty:!e(s.store).getBlocks(t).length}}),[t]).isEmpty;(0,c/* .useCourseLessonsStatusSync */.X)(t,o.isPreview);var w=(0,r.useCallback)((function(){return(0,r.createElement)(m/* ["default"] */.Z,{clientId:t})}),[t]),k=(0,r.useCallback)((function(){y?window.location.hash="generate-course-outline-using-ai":window.location.href="https://senseilms.com/sensei-pro/"}),[y]);return _?(0,r.createElement)(p/* ["default"] */.Z,{addBlock:function(e){return S([{type:e}],!0)},addBlocks:S,openTailoredModal:k}):(0,r.createElement)(g.Provider,{value:{outlineAttributes:o,outlineSetAttributes:a,outlineClassName:n}},(0,r.createElement)(l/* ["default"] */.Z,e),(0,r.createElement)("section",{className:n},(0,r.createElement)(s.InnerBlocks,{allowedBlocks:v,renderAppender:w})))}));
/***/},
/***/49650:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>h
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175),o=n(55609),i=n(65736),l=n(46173),a=n(69490),c=n(91444),u=n(20436),d=n(97921),m=n(92819),p=n(323),__=i.__,f=function(e){var t=e.addBlocks,n=e.openTailoredModal,i=void 0===n?m.noop:n;return(0,r.createElement)(o.Placeholder,{className:"wp-block-sensei-lms-course-outline__placeholder",label:__("Course Outline","sensei-lms"),icon:(0,r.createElement)(s.BlockIcon,{icon:l/* ["default"].icon */.Z.icon,showColors:!0}),instructions:__("Build and display a course outline.","sensei-lms")},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder__options"},(0,r.createElement)("button",{className:"wp-block-sensei-lms-course-outline__placeholder__option wp-block-sensei-lms-course-outline__placeholder__option-blank",onClick:function(){t([{type:"lesson",title:__("Lesson 1","sensei-lms")},{type:"lesson",title:__("Lesson 2","sensei-lms")},{type:"lesson",title:__("Lesson 3","sensei-lms")}])},"aria-labelledby":"generate-blank"},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content"},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__intro"},(0,r.createElement)("p",null,__("Start with a blank canvas and create your own course outline.","sensei-lms"))),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__details"},(0,r.createElement)("li",null,__("Add Lessons and Modules","sensei-lms")),(0,r.createElement)("li",null,__("Reorder and edit anytime","sensei-lms"))),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__lessons"},(0,r.createElement)("li",null,__("Lesson 1","sensei-lms")),(0,r.createElement)("li",null,__("Lesson 2","sensei-lms")))),(0,r.createElement)("figcaption",{className:"wp-block-sensei-lms-course-outline__placeholder__option__caption",id:"generate-blank"},__("Start with blank","sensei-lms"))),(0,r.createElement)("button",{className:"wp-block-sensei-lms-course-outline__placeholder__option is-ai","aria-labelledby":"generate-with-ai",onClick:function(){i()}},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content"},(0,r.createElement)("div",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__intro"},(0,r.createElement)("p",null,__("Get AI's help to start with a tailored course outline.","sensei-lms")),(0,r.createElement)(a/* ["default"] */.Z,{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__intro__icon"})),(0,r.createElement)("ul",{className:"wp-block-sensei-lms-course-outline__placeholder__option__content__details"},(0,r.createElement)("li",null,(0,r.createElement)(u/* ["default"] */.Z,{width:24,height:24}),__("AI tailored outline based on your content","sensei-lms")),(0,r.createElement)("li",null,(0,r.createElement)(u/* ["default"] */.Z,{width:24,height:24}),__("Access to all Sensei Pro features","sensei-lms"))),(0,r.createElement)(c/* ["default"] */.Z,null)),(0,r.createElement)("figcaption",{className:"wp-block-sensei-lms-course-outline__placeholder__option__caption",id:"generate-with-ai"},__("Generate with AI","sensei-lms"),(0,r.createElement)(d/* ["default"] */.Z,null)))))};
/* harmony import */
/* harmony default export */const h=function(e){var t=e.addBlock,n=e.addBlocks,s=e.openTailoredModal;return window.sensei.featureFlags.course_outline_ai?(0,r.createElement)(f,{addBlocks:n,openTailoredModal:s}):(0,r.createElement)(p/* .DeprecatedPlaceholder */.u,{addBlock:t})};
/***/},
/***/30553:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
/* harmony export */Z:()=>o
/* harmony export */});
/* harmony import */var r=n(69307),s=n(52175);
/* harmony import */
/* harmony default export */const o=function(){return(0,r.createElement)(s.InnerBlocks.Content,null)};
/***/},
/***/69384:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */Z:()=>i
/* harmony export */});
/* harmony import */var r=n(9818),s=n(45647),o=n(99196);
/* harmony import */
/* harmony default export */const i=function(){var e=(0,r.select)(s/* .EXTENSIONS_STORE */.h).getSenseiProExtension();return(0,o.useMemo)((function(){return{isActivated:Boolean(null==e?void 0:e.is_activated)}}),[null==e?void 0:e.is_activated])};
/***/},
/***/90799:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r,s=n(25773),o=n(53782),i=n(64649),l=n(69307),a=n(55609),c=n(65736),u=n(72469),d=["options","status","setStatus","disabled"],__=c.__,m=(r={},(0,i/* ["default"] */.Z)(r,u/* .Status.NOT_STARTED */.q.NOT_STARTED,__("Not Started","sensei-lms")),(0,i/* ["default"] */.Z)(r,u/* .Status.IN_PROGRESS */.q.IN_PROGRESS,__("In Progress","sensei-lms")),(0,i/* ["default"] */.Z)(r,u/* .Status.COMPLETED */.q.COMPLETED,__("Completed","sensei-lms")),r),p=function(e){var t=e.options,n=void 0===t?[u/* .Status.IN_PROGRESS */.q.IN_PROGRESS,u/* .Status.COMPLETED */.q.COMPLETED]:t,r=e.status,i=e.setStatus,c=e.disabled,p=(0,o/* ["default"] */.Z)(e,d),f=n.map((function(e){return{label:m[e],value:e}})),h=(0,l.createElement)(a.RadioControl,(0,s/* ["default"] */.Z)({className:"wp-block-sensei-lms-course-outline-status-control",help:__("Preview a status. The actual status that the student sees is determined by their progress in the course.","sensei-lms")},p,{options:f,selected:r,onChange:function(e){return i(e)}}));return c&&(h=(0,l.createElement)(a.Disabled,null,h)),h};
/* harmony import */}
/***/,
/***/62993:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */});
/* harmony import */var r=n(50189),s=n(90228),o=n(9818),i=n(72469),l=n(23418),a=n(20832),c={
/**
...
/**
   ...
   */
SET_LESSON_STATUS:function(e,t){var n=e.lessonId,o=e.status,l=(0,s/* ["default"] */.Z)(t.completedLessons);return i/* .Status.COMPLETED */.q.COMPLETED===o?l.includes(n)||l.push(n):l=l.filter((function(e){return e!==n})),(0,r/* ["default"] */.Z)((0,r/* ["default"] */.Z)({},t),{},{completedLessons:l})},
/**
...
/**
   ...
   * @return {Object} The new state.
   */
IGNORE_LESSON:function(e,t){var n=e.lessonId,s=t.completedLessons.filter((function(e){return e!==n})),o=t.trackedLessons.filter((function(e){return e!==n}));return(0,r/* ["default"] */.Z)((0,r/* ["default"] */.Z)({},t),{},{completedLessons:s,trackedLessons:o})},
/**
...
/* harmony import */(0,o.registerStore)(m,{reducer:(0,a/* .createReducerFromActionMap */.lA)(d,{completedLessons:[],trackedLessons:[]}),actions:c,selectors:u,controls:l.controls})}
/***/,
/***/31884:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(9818),s=n(69307),o=n(62993),i=function(e,t){var n=(0,r.useSelect)((function(t){return t("core/block-editor").getClientIdsOfDescendants([e])}),[e]),i=(0,r.useDispatch)(o/* .COURSE_STATUS_STORE */.o).stopTrackingRemovedLessons;(0,s.useEffect)((function(){t||i(n)}),[e,n,t,i])};
/* harmony import */}
/***/,
/***/31529:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */});
/* harmony import */var r=n(92819),s=n(9818),o=n(69307),i=n(69973),l=function(e){var t=(0,s.useDispatch)("core/block-editor").replaceInnerBlocks,n=(0,s.useSelect)((function(e){return e("core/block-editor")}),[]).getBlocks,l=(0,o.useCallback)((function(s){var o=arguments.length>1&&void 0!==arguments[1]&&arguments[1],l=n(e),a=(0,i/* .extractStructure */.Vw)(l);(0,r.isEqual)(a,s)||t(e,(0,i/* .syncStructureToBlocks */.pu)(s,l),o)}),[e,t,n]);return{setBlocks:l}};
/* harmony import */}
/***/,
/***/53227:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>c
/* harmony export */});
/* harmony import */var r=n(53782),s=n(69307),o=n(92819),i=n(4981),l=n(33731),a=["metadata","name"];
/* harmony import */
/* harmony default export */const c=function(e){(0,i.updateCategory)("sensei-lms",{icon:(0,s.createElement)(l/* ["default"] */.Z,{width:"20",height:"20"})}),e.forEach((function(e){var t=e.metadata,n=e.name,s=(0,r/* ["default"] */.Z)(e,a);t&&(
...
/* harmony import */var r=n(90228),s=n(64649),o=n(50189),i=n(92819),l=n(9818),a=n(23418),c=n(65736),u=n(20832),d=n(67959),__=(n(16400),c.__),m={IN_PROGRESS:"in-progress",IN_QUEUE:"in-queue"},p={
/**
...
/**
   ...
   */
installExtension:regeneratorRuntime.mark((function e(t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return(0,d/* .logEvent */.K)("extensions_install",{slug:t}),e.next=3,p.runProcess({slugs:[t],actionType:"install"});case 3:case"end":return e.stop()}}),e)})),
/**
   * Updates the provided extensions.
   *
   * @param {string[]} slugs The extension slugs to update.
   */
updateExtensions:regeneratorRuntime.mark((function e(t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return t.map((function(e){return(0,d/* .logEvent */.K)("extensions_update",{slug:e})})),e.next=3,p.runProcess({slugs:t,actionType:"update"});case 3:case"end":return e.stop()}}),e)})),
/**
   ...
   */
runProcess:regeneratorRuntime.mark((function e(t){var n,r,s,o,u,d,f;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=t.slugs,r=t.actionType,e.next=3,(0,l.select)(g).getExtensionsByStatus(m.IN_PROGRESS);case 3:if(!(e.sent.length>0)){e.next=8;break}return e.next=7,p.addToQueue(t);case 7:return e.abrupt("return");case 8:return e.next=10,p.setExtensionsStatus(n,m.IN_PROGRESS);case 10:return"update"===r?(s={plugins:n},o=__("Update completed successfully!","sensei-lms"),// translators: Placeholder is the underlying error message.
u=__("There was an error while updating the plugin: %1$s","sensei-lms")):(s={plugin:n[0]},o=__("Installation completed successfully!","sensei-lms"),// translators: Placeholder is the underlying error message.
u=__("There was an error while installing the plugin: %1$s","sensei-lms")),e.prev=11,e.next=14,(0,a.apiFetch)({path:"/sensei-internal/v1/sensei-extensions/".concat(r),method:"POST",data:s});case 14:return d=e.sent,e.next=17,p.setError(null);case 17:return e.next=19,p.setEntities({extensions:(0,i.keyBy)(d.completed,"product_slug")});case 19:return e.next=21,(0,l.dispatch)("core/notices").createNotice("success",o,{type:"snackbar"});case 21:e.next=27;break;case 23:return e.prev=23,e.t0=e.catch(11),e.next=27,p.setError((0,c.sprintf)(u,e.t0.message));case 27:return e.prev=27,e.next=30,p.setExtensionsStatus(n,"");case 30:return e.next=32,p.removeFromQueue(t);case 32:return e.next=34,(0,l.select)(g).getNextProcess();case 34:if(!(f=e.sent)){e.next=38;break}return e.next=38,p.runProcess(f);case 38:return e.finish(27);case 39:case"end":return e.stop()}}),e,null,[[11,23,27,39]])})),
/**
...
/**
   ...
   * @param {string[]} process.slugs      Extension slugs.
   */
addToQueue:regeneratorRuntime.mark((function e(t){return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,p.setExtensionsStatus(t.slugs,m.IN_QUEUE);case 2:return e.abrupt("return",{type:"ADD_TO_QUEUE",process:t});case 3:case"end":return e.stop()}}),e)})),
/**
   * Add process (update/install) to queue.
   *
   * @param {Object}   process       The process.
...
/**
   ...
   */
setError:function(e){return{type:"SET_ERROR",error:e}}},f={getExtensions:function(e){var t=e.extensionSlugs,n=e.entities;return t.map((function(e){return n.extensions[e]}))},getExtensionsByStatus:function(e,t){return f.getExtensions(e).filter((function(e){return t===e.status}))},getSenseiProExtension:(0,l.createRegistrySelector)((function(e){return function(){return e(g).getExtensions().find((function(e){return"sensei-pro"===e.product_slug}))}})),getEntities:function(e,t){return e.entities[t]},getConnectionStatus:function(e){return e.connected},getNextProcess:function(e){return e.queue[0]||null},getError:function(e){return e.error}},h={
/**
   * Loads the extensions during initialization.
   */
getExtensions:regeneratorRuntime.mark((function e(){var t;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,a.apiFetch)({path:"/sensei-internal/v1/sensei-extensions?type=plugin"});case 2:return t=e.sent,e.next=5,p.setEntities({extensions:(0,i.keyBy)(t.extensions,"product_slug")});case 5:return e.next=7,p.setExtensions(t.extensions.map((function(e){return e.product_slug})));case 7:case"end":return e.stop()}}),e)}))},v={SET_EXTENSIONS:function(e,t){var n=e.extensionSlugs;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{extensionSlugs:n})},SET_EXTENSIONS_STATUS:function(e,t){var n=e.slugs,r=e.status;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{entities:(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t.entities),{},{extensions:Object.keys(t.entities.extensions).reduce((function(e,i){return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},e),{},(0,s/* ["default"] */.Z)({},i,(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t.entities.extensions[i]),{},{status:n.includes(i)?r:t.entities.extensions[i].status})))}),{})})})},SET_CONNECTION_STATUS:function(e,t){var n=e.connected;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{connected:n})},SET_LAYOUT:function(e,t){var n=e.layout;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{layout:n})},SET_ENTITIES:function(e,t){var n=e.entities;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{entities:(0,i.merge)({},t.entities,n)})},ADD_TO_QUEUE:function(e,t){var n=e.process;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{queue:[].concat((0,r/* ["default"] */.Z)(t.queue),[n])})},REMOVE_FROM_QUEUE:function(e,t){var n=e.process;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{queue:t.queue.filter((function(e){return!(0,i.isEqual)(e,n)}))})},SET_ERROR:function(e,t){var n=e.error;return(0,o/* ["default"] */.Z)((0,o/* ["default"] */.Z)({},t),{},{error:n})},DEFAULT:function(e,t){return t}},g=(0,l.createReduxStore)("sensei/extensions",{reducer:(0,u/* .createReducerFromActionMap */.lA)(v,{
/**
...
/**
   ...
   */
entities:{extensions:{}},connected:!1,layout:[],queue:[],error:null}),actions:p,selectors:f,resolvers:h,controls:a.controls});
/* harmony import */(0,l.register)(g)}
/***/,
/***/39359:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
var r={primaryColor:a(n).backgroundColor,primaryContrastColor:a(n).color};// Remove probe.
...
/* harmony import */var r=n(90228),s=n(66886),o=n(25773),i=n(50189),l=n(69307),a=n(92819),c=n(52175),u=n(65736),d=n(39359),__=u.__,m=function(e){return function(t){var n=(0,a.mapValues)(e,(function(e){return e.style}));return(0,c.withColors)(n)((function(n){return(0,l.createElement)(l.Fragment,null,(0,l.createElement)(t,n),(0,l.createElement)(p,{colorSettings:e,props:n}))}))}},p=function(e){var t,n,r,s,o=e.colorSettings,u=e.props,d=Object.keys(o).map((function(e){return{value:u[e].color,label:o[e].label,onChange:function(t){u["set".concat((0,a.upperFirst)(e))](t),o[e].onChange&&o[e].onChange((0,i/* ["default"] */.Z)((0,i/* ["default"] */.Z)({},u),{},{colorValue:t}))}}})),m=(null===(t=u.backgroundColor)||void 0===t||null===(n=t.color)||void 0===n?void 0:n.includes("var"))||(null===(r=u.textColor)||void 0===r||null===(s=r.color)||void 0===s?void 0:s.includes("var")),p=u.backgroundColor&&u.textColor&&!m;return(0,l.createElement)(c.InspectorControls,null,(0,l.createElement)(c.PanelColorSettings,{title:__("Color settings","sensei-lms"),initialOpen:!1,colorSettings:d},p&&(0,l.createElement)(c.ContrastChecker,{textColor:u.textColor.color,backgroundColor:u.backgroundColor.color,isLargeText:!1})))},f=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"default";return function(t){return function(n){var r=n.className,s={};r&&r.includes("is-style-")||(r=s.className=[r,"is-style-".concat(e)].join(" "));var i=r.match(/is-style-(\w+)/);return i&&(s.blockStyle=i[1]),(0,l.createElement)(t,(0,o/* ["default"] */.Z)({},n,s))}}},h=function(e){return function(t){return function(n){var a=n.setAttributes,u=n.attributes,m=(0,d/* .useColorsByProbe */.o)(),p=(0,l.useState)({}),f=(0,s/* ["default"] */.Z)(p,2),h=f[0],v=f[1],g=Object.keys(e).map((function(e){return u[e]}));return(0,l.useEffect)((function(){var t={};Object.entries(e).forEach((function(e){var n=(0,s/* ["default"] */.Z)(e,2),r=n[0],o=n[1],l=o.style,d=o.probeKey,p=m[d]||{},f=p.slug;if(f&&(t[r]=(0,i/* ["default"] */.Z)((0,i/* ["default"] */.Z)({},p),{},{className:(0,c.getColorClassName)(l,f)})),u[r]!==f){var h={};h[r]=f,// Border color is not compatible with all themes as className, so the color value is needed.
"border-color"===l&&(h["".concat(r,"Value")]=p.color),a(h)}})),v(t)}),[m,a].concat((0,r/* ["default"] */.Z)(g))),(0,l.createElement)(t,(0,o/* ["default"] */.Z)({},n,h))}}};
/* harmony import */}
/***/,
/***/3295:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>d
/* harmony export */});
/* harmony import */var r=n(25773),s=n(53782),o=n(69307),i=n(60042),l=n.n(i),a=n(52175),c=n(39630),u=["onChange","onKeyDown","value","onEnter","onRemove"];
/* harmony import */
...
/* harmony export */});
/* harmony import */var r=n(4981),s=n(9818),o=n(69307),i=n(92819),l=function(e,t){var n=e.name,l=e.attributes,a=void 0===l?{}:l,c=e.selectFirstBlock,u=void 0!==c&&c,d=e.isEmptyBlock,m=t.clientId,p=(0,s.useDispatch)("core/block-editor"),f=p.__unstableMarkNextChangeAsNotPersistent,h=void 0===f?i.noop:f,v=p.insertBlock,g=(0,s.useSelect)((function(e){return e("core/block-editor").getBlocks(m)})),E=0===g.length,b=(0,o.useCallback)((function(){var e=(0,r.createBlock)(n,a),t=E&&u;h(),v(e,void 0,m,t)}),[h,v,m,n,a,E,u]),y=g.length&&g[g.length-1],S=y&&d(y.attributes);(0,o.useEffect)((function(){S||b()}),[S,b])};
/* harmony import */}
/***/,
/***/26622:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */});
/* harmony import */var r=n(4981),s=n(9818),o=n(39630),i=function(e){var t=e.insertBlocksAfter,n=e.name,i=e.clientId,l=e.attributes.title,a=(0,s.useDispatch)("core/block-editor"),c=a.selectNextBlock,u=a.removeBlock;return{onKeyDown:function(e){switch(e.keyCode){case o.ENTER:a=(0,s.select)("core/block-editor"),!(d=a.getBlock(a.getNextBlockClientId()))||d.attributes.title?t([(0,r.createBlock)(n)]):c(i);break;case o.BACKSPACE:!function(e){0===l.length&&(e.preventDefault(),u(i))}(e)}var a,d}}};
/* harmony import */}
/***/,
/***/69490:
/***/(e,t,n)=>{"use strict";
...
/* harmony export */Z:()=>l
/* harmony export */});
/* harmony import */var r=n(25773),s=n(53782),o=n(69307),i=["size"];
/* harmony import */
/* harmony default export */const l=function(e){var t=e.size,n=void 0===t?24:t,l=(0,s/* ["default"] */.Z)(e,i);return(0,o.createElement)("svg",(0,r/* ["default"] */.Z)({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",height:n,width:n,fill:"none"},l),(0,o.createElement)("path",{fill:"#1E1E1E",d:"M17.566 18.434L17 17l-.566 1.434L15 19l1.434.566L17 21l.566-1.434L19 19l-1.434-.566zM7.566 5.434L7 4l-.566 1.434L5 6l1.434.566L7 8l.566-1.434L9 6l-1.434-.566zM17.849 5.151L17 3l-.849 2.151L14 6l2.151.849L17 9l.849-2.151L20 6l-2.151-.849z"}),(0,o.createElement)("path",{fill:"#1E1E1E",fillRule:"evenodd",d:"M12.223 8.065a.75.75 0 00-.61 0l-5.168 2.297a.75.75 0 000 1.37l1.852.823v3.36c0 .254.128.49.34.628l.41-.628-.41.628v.001l.003.001.005.003.017.012a8.218 8.218 0 00.28.17c.185.108.444.252.744.397.57.276 1.4.613 2.165.623.793.01 1.658-.328 2.251-.608a10.93 10.93 0 001.067-.58l.018-.01.006-.004.002-.001v-.001l-.405-.63.406.63a.75.75 0 00.344-.63v-3.36l1.851-.824a.75.75 0 000-1.37l-5.168-2.297zm1.816 5.157l-1.816.807a.75.75 0 01-.61 0l-1.816-.807v2.27c.148.083.334.184.542.285.543.262 1.12.468 1.532.473.427.006 1.026-.198 1.592-.465.222-.104.42-.21.577-.297v-2.266zm-2.12-.699l-3.322-1.476 3.321-1.476 3.322 1.476-3.322 1.476z",clipRule:"evenodd"}))};
/***/},
/***/97921:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */
/* harmony default export */const o=function(){return(0,r.createElement)("span",{className:"sensei-pro-badge"},__("Pro","sensei-lms"))};
/***/},
/***/92239:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
if(!e||null===e.match("#"))return e;var t=0,n=0,r=0,s=4===e.length?"#".concat(e[1]+e[1]+e[2]+e[2]+e[3]+e[3]):e;return 7===s.length&&(t=parseInt(s.substr(1,2),16)||0,n=parseInt(s.substr(3,2),16)||0,r=parseInt(s.substr(5,2),16)||0),"rgb(".concat(t,", ").concat(n,", ").concat(r,")")};
/***/},
/***/67959:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony export */});
/* harmony import */var r=n(50189),s=n(53782),o=n(92819),i=n(23418),l=n(9818),a=n(20832),c=(n(16400),["storeName","getEndpoint","saveError","fetchError","clearError","updateBlock","blockExists","readBlock","setServerStructure"]);
/* harmony import */
/**
