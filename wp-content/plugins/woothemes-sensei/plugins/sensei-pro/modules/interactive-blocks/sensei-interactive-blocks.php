...
define( 'SENSEI_PRO_VERSION', '1.12.0' ); // Note: this is the current sensei-pro version this plugin was built from, needed so the correct language packs are loaded (in shared module).
define( 'SENSEI_IB_VERSION', '1.2.2' );
