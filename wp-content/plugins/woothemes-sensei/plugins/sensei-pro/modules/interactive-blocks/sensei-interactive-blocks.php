...
define( 'SENSEI_PRO_VERSION', '1.20.1' ); // Note: this is the current sensei-pro version this plugin was built from, needed so the correct language packs are loaded (in shared module).
